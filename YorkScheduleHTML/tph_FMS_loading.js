...
//////////////////////  Settings for TEXT //////////////////////
		...
		var loading_text_color="rgb(161, 10, 25)";			//text color in rgb
		var text_x_pos= (_width/2);							//text orizontal position: use (_width/2) to center
		var text_y_pos= (_height/4) * 3;								//text vertical position: use (_height/2) to center
//////////////////////  LOADING BAR SETTINGS ////////////////////////////////	
		var barwidth = (_width / 100) * 50 ;					//Loading bar width in pixel, use (_width / 100) * 50 to have a bar 50% width of screen
		var barheight = (_height / 2);                          	// Loading bar height in pixel
		var x = (_width - barwidth) / 2;				// Loading bar orizizontal position (in example centered orizontally)
		var y = (_height - barheight) / 2;		// Loading bar vertical position (in example moved 150px down from center)
		var w = (barwidth / _total) * _current;         //variable to calculate width during loading progress, DON'T EDIT
		var border=0   								// Bar border width in pixel
		var border_color= "rgb(0,255,0)";   			//Bar border color in rgb
		var bar_bg= "rgb(20,20,20)";   					//Bar Background color 
		var progress_bg= "rgb(161,10,25)";  			//Progress Bar color
///////////////////// BACKGROUND SETTINGS   ///////////////////////////////////
		var window_bgd="rgb(20,20,20)"; 				//Background color 
...
//////////////////// CUSTOM IMAGE SETTINGS TO BE USED INSTEAD OR TOGETHER GM:S LOADING SCREEN, LEAVE URL EMPTY IF NOT NEEDED		
		...
		customlogo.src = "http://i.imgur.com/JxqBoeH.png"; 						//URL to custom image, leave empty in not needed
		var imgheight= 180*3;							//custom image height in pixel (use _height to fit canvas)
		var imgwidth= 348*3;							//custom image width in pixel (use _width to fit canvas)
